...
inputs = {'vcenter_ip': 'vcenter6.accelops.net',
          'vcenter_password': '4BJs1!mu8bQG',
          'vcenter_user': 'qguo@accelops.net',
          'vm_name' : 'FortiSIEM-VA',
          'isDHCP' : False,
          'vm_ip' : '172.30.57.50',
          'subnet' : '255.255.252.0',
          'gateway' : '172.30.59.255',
          'dns' : ['172.30.52.31', '172.30.52.32'],
          'domain' : 'domain.fortinet.com'
          }
...
def main():
    ...
    try:
        ...
        si = connect.ConnectNoSSL(inputs['vcenter_ip'], 443, inputs['vcenter_user'], inputs['vcenter_password'])
    except IOError, e:
        pass
    ...
    ident = vim.vm.customization.LinuxPrep(domain=inputs['domain'], hostName=vim.vm.customization.FixedName(name='FortiSIEM-VA'))
