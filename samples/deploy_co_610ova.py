...
def main():
    ...
    if args.network:
        ...
        cisp = vim.OvfManager.CreateImportSpecParams(entityName='AutomationCOServer610', diskProvisioning='thin',
        ...
        # networkMapping (to map to networks)
        # propertyMapping (descriptor specific properties)
        cisp = vim.OvfManager.CreateImportSpecParams(entityName='AutomationCOServer610',
