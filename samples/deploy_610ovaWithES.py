...
def main():
    ...
    if args.network:
        ...
        cisp = vim.OvfManager.CreateImportSpecParams(entityName='AutomationServer610WithES', diskProvisioning='thin',
        ...
        # networkMapping (to map to networks)
        # propertyMapping (descriptor specific properties)
        cisp = vim.OvfManager.CreateImportSpecParams(entityName='AutomationServer610WithES', diskProvisioning='thin')  # deploy disk type is thin, default is thick
        cisr = ovfManager.CreateImportSpec(ovf_handle.get_descriptor(),
                                           rp, ds, cisp)
